...
ActiveRecord::Schema.define(version: 2022_03_14_013053) do

  create_table "article_tagmaps", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "article_id", null: false
    t.bigint "article_tag_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["article_id"], name: "index_article_tagmaps_on_article_id"
    t.index ["article_tag_id"], name: "index_article_tagmaps_on_article_tag_id"
  end
  ...
  create_table "articles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["title", "user_id"], name: "index_articles_on_title_and_user_id", unique: true
  ...
  add_foreign_key "article_tagmaps", "article_tags"
  add_foreign_key "article_tagmaps", "articles"
